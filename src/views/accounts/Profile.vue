  ...
  <div class="profile-main">
    ...
    <div class="profile-body-frame">
      ...
      <ul class="profile-ul" :class="{hide:wish_btn_toggle}">
        <span class="list-item locate text-animation" v-for="wish in user_info.wish_movie" :key="wish.id" :wish="wish"  >
          <p style="margin:0" class="text-animation" @click="movieDetail(wish)">{{wish.title}}
            </p>
